...
#define PFC_USER_RUN_MODE                    PFC_USER_MODE_RAW_ADC /* 当前运行权限；默认值确保任何PD0操作都无PWM。 */
...
#define PFC_USER_5V_CALIBRATION_CONFIRMED    0U         /* 0=只允许RAW_ADC；全部零点/比例/极性/阈值实测后才改1，改1本身不会自动完成标定。 */
