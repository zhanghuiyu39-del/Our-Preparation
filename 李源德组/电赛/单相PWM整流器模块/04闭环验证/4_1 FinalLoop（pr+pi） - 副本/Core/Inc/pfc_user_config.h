 ...
 */
#define PFC_USER_ACTIVE_PROFILE              PFC_USER_PROFILE_36V_LIGHT_100R /* 当前默认使用36 V RMS输入、60 V母线和100 ohm负载参数。 */
...
#define PFC_USER_36V_LIGHT_CURRENT_TRIP_A_PEAK     2.50f      /* A peak，软件/AWD关断值；高于1.344 A RMS指令对应的1.90 A峰值。 */
 ...
 * 6. 当前36 V轻载档不再设置额外硬件确认宏；软件在VAC、VBUS和ADC同步有效后允许PD0启动。
 *    FLT3、66 V母线过压、1.80 A峰值过流、ADC/DMA失步和控制数值异常仍会立即关闭PWM。
 */
