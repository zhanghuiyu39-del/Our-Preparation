...
#elif PFC_USER_ACTIVE_PROFILE == PFC_USER_PROFILE_36V_MID_50R
#define PFC_CFG_PROFILE_ID                 PFC_PROFILE_36V_MID_50R
#define PFC_CFG_CALIBRATION_CONFIRMED      PFC_USER_36V_CALIBRATION_CONFIRMED
#define PFC_CFG_VAC_NOMINAL_RMS            PFC_USER_36V_MID_VAC_NOMINAL_RMS
#define PFC_CFG_GRID_FREQUENCY_HZ          PFC_USER_36V_MID_GRID_FREQUENCY_HZ
#define PFC_CFG_GRID_TOLERANCE_HZ          PFC_USER_36V_MID_GRID_TOLERANCE_HZ
#define PFC_CFG_VAC_PEAK_TRIP_V            PFC_USER_36V_MID_VAC_PEAK_TRIP_V
#define PFC_CFG_VBUS_TARGET_V              PFC_USER_36V_MID_VBUS_TARGET_V
#define PFC_CFG_VBUS_START_MIN_V           PFC_USER_36V_MID_VBUS_START_MIN_V
#define PFC_CFG_VBUS_RUN_MIN_V             PFC_USER_36V_MID_VBUS_RUN_MIN_V
#define PFC_CFG_VBUS_WARN_V                PFC_USER_36V_MID_VBUS_WARN_V
#define PFC_CFG_VBUS_TRIP_V                PFC_USER_36V_MID_VBUS_TRIP_V
#define PFC_CFG_VBUS_TOLERANCE_V           PFC_USER_36V_MID_VBUS_TOLERANCE_V
#define PFC_CFG_LOAD_RESISTANCE_OHM        PFC_USER_36V_MID_LOAD_RESISTANCE_OHM
#define PFC_CFG_INPUT_INDUCTANCE_H         PFC_USER_36V_MID_INPUT_INDUCTANCE_H
#define PFC_CFG_BUS_CAPACITANCE_F          PFC_USER_36V_MID_BUS_CAPACITANCE_F
#define PFC_CFG_CONTROL_FREQUENCY_HZ       PFC_USER_36V_MID_CONTROL_FREQUENCY_HZ
#define PFC_CFG_MODULATION_LIMIT           PFC_USER_36V_MID_MODULATION_LIMIT
#define PFC_CFG_CURRENT_TARGET_A_PEAK      PFC_USER_36V_MID_CURRENT_TARGET_A_PEAK
#define PFC_CFG_CURRENT_RAMP_A_PER_S       PFC_USER_36V_MID_CURRENT_RAMP_A_PER_S
#define PFC_CFG_CURRENT_TRIP_A_PEAK        PFC_USER_36V_MID_CURRENT_TRIP_A_PEAK
#define PFC_CFG_PR_KP                      PFC_USER_36V_MID_PR_KP
#define PFC_CFG_PR_KR                      PFC_USER_36V_MID_PR_KR
#define PFC_CFG_PR_BANDWIDTH_RAD_S         PFC_USER_36V_MID_PR_BANDWIDTH_RAD_S
#define PFC_CFG_PR_OUTPUT_LIMIT_V          PFC_USER_36V_MID_PR_OUTPUT_LIMIT_V
#define PFC_CFG_PI_KP_A_PER_V              PFC_USER_36V_MID_PI_KP_A_PER_V
#define PFC_CFG_PI_KI_A_PER_VS             PFC_USER_36V_MID_PI_KI_A_PER_VS
#define PFC_CFG_VOLTAGE_LOOP_HZ            PFC_USER_36V_MID_VOLTAGE_LOOP_HZ
#define PFC_CFG_NOTCH_DAMPING_RAD_S        PFC_USER_36V_MID_NOTCH_DAMPING_RAD_S
#define PFC_CFG_VBUS_SLEW_V_PER_S          PFC_USER_36V_MID_VBUS_SLEW_V_PER_S
#define PFC_CFG_PROBE_CURRENT_A_RMS        PFC_USER_36V_MID_PROBE_CURRENT_A_RMS
#define PFC_CFG_PROBE_SLEW_A_PER_S         PFC_USER_36V_MID_PROBE_SLEW_A_PER_S
#define PFC_CFG_CURRENT_ERROR_MAX_A_RMS    PFC_USER_36V_MID_CURRENT_ERROR_MAX_A_RMS
#define PFC_CFG_PROBE_MIN_MS               PFC_USER_36V_MID_PROBE_MIN_MS
#define PFC_CFG_CURRENT_TIMEOUT_MS         PFC_USER_36V_MID_CURRENT_TIMEOUT_MS
#define PFC_CFG_VBUS_TIMEOUT_MS            PFC_USER_36V_MID_VBUS_TIMEOUT_MS
#define PFC_CFG_SATURATION_SAMPLES         PFC_USER_36V_MID_SATURATION_SAMPLES
#define PFC_CFG_PERIOD_SATURATION_RATIO    PFC_USER_36V_MID_PERIOD_SATURATION_RATIO
#define PFC_CFG_PERIOD_SATURATION_CYCLES   PFC_USER_36V_MID_PERIOD_SATURATION_CYCLES
#define PFC_CFG_VBUS_REGULATION_TIMEOUT_MS PFC_USER_36V_MID_VBUS_REGULATION_TIMEOUT_MS
#define PFC_CFG_IPFC_A_PER_COUNT           PFC_USER_36V_IPFC_A_PER_COUNT
#define PFC_CFG_VAC_V_PER_COUNT            PFC_USER_36V_VAC_V_PER_COUNT
#define PFC_CFG_VBUS_V_PER_COUNT           PFC_USER_36V_VBUS_V_PER_COUNT
#define PFC_CFG_IPFC_ZERO_COUNT            PFC_USER_36V_IPFC_ZERO_COUNT
...
uint32_t PFC_Params_GetValidationError(const PFC_Params *params)
{
    ...
    if (((params->profile_id != PFC_PROFILE_5V_TEST) &&
         ...
         (params->profile_id != PFC_PROFILE_36V_MID_50R) &&
