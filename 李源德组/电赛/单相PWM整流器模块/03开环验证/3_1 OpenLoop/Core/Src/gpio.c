...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PFC_NFAULT_DIAG_Pin */
  GPIO_InitStruct.Pin = PFC_NFAULT_DIAG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PFC_NFAULT_DIAG_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PFC_START_KEY_Pin */
  GPIO_InitStruct.Pin = PFC_START_KEY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PFC_START_KEY_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PFC_GATE_EN_Pin */
  GPIO_InitStruct.Pin = PFC_GATE_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PFC_GATE_EN_GPIO_Port, &GPIO_InitStruct);
