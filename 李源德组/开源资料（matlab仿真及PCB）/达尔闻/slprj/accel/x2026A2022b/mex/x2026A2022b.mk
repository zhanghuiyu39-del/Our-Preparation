...
MODEL                   = x2026A2022b
MODULES                 = x2026A2022b_acc.c rtGetInf.c rtGetNaN.c rt_nonfinite.c x2026A2022b_acc_data.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\x2026A2022b_acc.mexw64
MAKEFILE                = x2026A2022b.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:x2026A2022b_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = x2026A2022b_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = x2026A2022b_ref.rsp
COMPILER_COMMAND_FILE     = x2026A2022b_comp.rsp
...
x2026A2022b_acc.obj : $(START_DIR)\slprj\accel\x2026A2022b\x2026A2022b_acc.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\x2026A2022b\x2026A2022b_acc.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\x2026A2022b\x2026A2022b_acc.c

rtGetInf.obj : $(START_DIR)\slprj\accel\x2026A2022b\rtGetInf.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\x2026A2022b\rtGetInf.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\x2026A2022b\rtGetInf.c

rtGetNaN.obj : $(START_DIR)\slprj\accel\x2026A2022b\rtGetNaN.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\x2026A2022b\rtGetNaN.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\x2026A2022b\rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\x2026A2022b\rt_nonfinite.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\x2026A2022b\rt_nonfinite.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\x2026A2022b\rt_nonfinite.c

x2026A2022b_acc_data.obj : $(START_DIR)\slprj\accel\x2026A2022b\x2026A2022b_acc_data.c
	@cmd /C "echo ### Compiling $(START_DIR)\slprj\accel\x2026A2022b\x2026A2022b_acc_data.c
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\x2026A2022b\x2026A2022b_acc_data.c
