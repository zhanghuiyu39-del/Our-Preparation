...
HD_PWD='D:/fpga/AM_Decoder/AM_Decoder.runs/dds_compiler_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_compiler_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_compiler_1.tcl
