...
HD_PWD='D:/fpga/AM_Decoder/AM_Decoder.runs/cordic_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_1.tcl
