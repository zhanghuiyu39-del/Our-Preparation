...
HD_PWD='D:/fpga/AM_Decoder/AM_Decoder.runs/system_AM_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_AM_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_AM_decoder_0_0.tcl
