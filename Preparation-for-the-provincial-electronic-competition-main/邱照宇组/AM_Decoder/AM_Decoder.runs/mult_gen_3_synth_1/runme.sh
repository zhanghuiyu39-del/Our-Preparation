...
HD_PWD='D:/fpga/AM_Decoder/AM_Decoder.runs/mult_gen_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_3.tcl
