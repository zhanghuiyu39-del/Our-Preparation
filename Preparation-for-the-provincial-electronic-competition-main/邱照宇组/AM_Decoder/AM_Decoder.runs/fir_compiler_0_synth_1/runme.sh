...
HD_PWD='D:/fpga/AM_Decoder/AM_Decoder.runs/fir_compiler_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler_0.tcl
