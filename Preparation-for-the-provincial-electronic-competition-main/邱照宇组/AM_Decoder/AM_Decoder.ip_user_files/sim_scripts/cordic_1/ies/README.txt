...
#
# Generated by export_simulation on Thu Jun 18 17:54:50 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './cordic_1.sh' script.

./cordic_1.sh -reset_run
...
./cordic_1.sh -noclean_files

For more information on the script, please type './cordic_1.sh -help'.
