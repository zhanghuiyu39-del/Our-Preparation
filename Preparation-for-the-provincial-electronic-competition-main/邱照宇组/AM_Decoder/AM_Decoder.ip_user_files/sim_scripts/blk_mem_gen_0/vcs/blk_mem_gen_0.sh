...
#
# Generated by Vivado on Sun Jun 14 20:08:07 +0800 2026
...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm blk_mem_gen_v8_4_2)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_2 $vlogan_opts +v2k +incdir+"D:/xlinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/xlinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../AM_Decoder.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
