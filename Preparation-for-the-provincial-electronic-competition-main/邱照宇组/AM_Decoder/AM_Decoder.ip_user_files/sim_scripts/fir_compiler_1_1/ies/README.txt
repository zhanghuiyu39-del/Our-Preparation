...
#
# Generated by export_simulation on Wed Jun 17 17:42:47 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './fir_compiler_1.sh' script.

./fir_compiler_1.sh -reset_run
...
./fir_compiler_1.sh -noclean_files

For more information on the script, please type './fir_compiler_1.sh -help'.
