...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm xbip_utils_v3_0_9 axi_utils_v2_0_5 xbip_pipe_v3_0_5 xbip_bram18k_v3_0_5 mult_gen_v12_0_14 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_5 xbip_dsp48_multadd_v3_0_5 dds_compiler_v6_0_17)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../AM_Decoder.srcs/sources_1/ip/dds_compiler_1/sim/dds_compiler_1.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dds_compiler_1 xil_defaultlib.glbl -o dds_compiler_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dds_compiler_1_simv $vcs_sim_opts -do simulate.do
}
