...
MCU pin mapping used by this project:
SCK--PC13    SDI--PC14   SEN---PC15
**********************************************************/
...
// ADF4002 software-serial pins: PC13(SCK), PC14(SDI), PC15(SEN)
//GND
#define PLL_SCK PCout(13)
#define PLL_SDI PCout(14)
#define PLL_SEN PCout(15)
